...
A highly opinionated Go library for builing Prometheus exporters quickly.
...
This repo includes a [more complete example](https://github.com/d0ugal/promexporter/tree/main/examples/random-exporter).
